<?php include 'shared/head.php'?>
	<header class="axle_header"><h1>| Axle | 'form elements'</h1></header>
	<article class="axle_body form_styleguide">
		<?php include 'shared/nav.php'?>		
		<header>
			<p>1. input type="text" w/label and instructional text</p>
		</header>
